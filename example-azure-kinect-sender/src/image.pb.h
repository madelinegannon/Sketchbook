...
namespace google {
namespace protobuf {
template<> ::kinect::Image* Arena::CreateMaybeMessage<::kinect::Image>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace kinect {
...
class Image : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kinect.Image) */ {
 public:
  Image();
  virtual ~Image();
  ...
  // @@protoc_insertion_point(class_scope:kinect.Image)
 private:
...
inline ::google::protobuf::int32 Image::width() const {
  // @@protoc_insertion_point(field_get:kinect.Image.width)
  return width_;
}
inline void Image::set_width(::google::protobuf::int32 value) {
  
  width_ = value;
  // @@protoc_insertion_point(field_set:kinect.Image.width)
}
...
inline ::google::protobuf::int32 Image::height() const {
  // @@protoc_insertion_point(field_get:kinect.Image.height)
  return height_;
}
inline void Image::set_height(::google::protobuf::int32 value) {
  
  height_ = value;
  // @@protoc_insertion_point(field_set:kinect.Image.height)
}
...
inline ::google::protobuf::int32 Image::stride() const {
  // @@protoc_insertion_point(field_get:kinect.Image.stride)
  return stride_;
}
inline void Image::set_stride(::google::protobuf::int32 value) {
  
  stride_ = value;
  // @@protoc_insertion_point(field_set:kinect.Image.stride)
}
...
inline const ::std::string& Image::image_data() const {
  // @@protoc_insertion_point(field_get:kinect.Image.image_data)
...
inline void Image::set_image_data(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:kinect.Image.image_data)
}
#if LANG_CXX11
inline void Image::set_image_data(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:kinect.Image.image_data)
}
#endif
inline void Image::set_image_data(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:kinect.Image.image_data)
}
inline void Image::set_image_data(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:kinect.Image.image_data)
}
inline ::std::string* Image::mutable_image_data() {
  
  // @@protoc_insertion_point(field_mutable:kinect.Image.image_data)
...
inline ::std::string* Image::release_image_data() {
  // @@protoc_insertion_point(field_release:kinect.Image.image_data)
...
inline void Image::set_allocated_image_data(::std::string* image_data) {
  ...
  // @@protoc_insertion_point(field_set_allocated:kinect.Image.image_data)
}
